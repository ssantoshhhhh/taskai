...
const GlobalSpotlight = ({
  ...
  glowColor = DEFAULT_GLOW_COLOR
}: { gridRef: React.RefObject<HTMLDivElement>, disableAnimations?: boolean, enabled?: boolean, spotlightRadius?: number, glowColor?: string }) => {
            ...
            if (enableStars) {
              return (
                ...
                >
                  ...
                  <div className="card__content flex flex-col relative text-white cursor-pointer" onClick={card.onClick}>
